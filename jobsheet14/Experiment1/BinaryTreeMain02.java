...
public class BinaryTreeMain02 {
    public static void main(String[] args) {
        BinaryTree02 bst = new BinaryTree02();
         bst.add(new Student02("244107020138", "Devin", "TI-1I", 3.57));
        bst.add(new Student02("244107020023", "Dewi", "TI-1I", 3.85));
        bst.add(new Student02("244107020225", "Wahyu", "TI-1I", 3.21));
        bst.add(new Student02("244107020076", "Angelina", "TI-1I", 3.54));
        ...
        bst.add(new Student02("244107020223", "Andhika", "TI-1I", 3.72));
        bst.add(new Student02("244107020226", "Bima", "TI-1I", 3.37));
        bst.add(new Student02("244107020181", "Eiyu", "TI-1I", 3.46));
